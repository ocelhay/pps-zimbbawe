output$qc_table <- DT::renderDT({
  ...
  qc_1 <- tibble(Issue = "Ward form records without any patient", 
                 ODK_ID = id_1)
  ...
  qc_2 <- tibble(Issue = "Patients form records not linked to a ward", 
                 ODK_ID = id_2)
  ...
  qc_3 <- tibble(Issue = "Antibio form records not linked to a patient", 
                 ODK_ID = id_3)
  ...
  qc_4 <- tibble(Issue = "Microbio form records not linked to a patient", 
                 ODK_ID = id_4)
